<main>
        ...
        <section id="home"> 
            <div id="figs">
                <div class="imagem">
                    <img src="<?php echo URL_TEMPLATE?>/imagens/img1.png" />
                </div>
                <div class="imagem">
                    <img src="<?php echo URL_TEMPLATE?>/imagens/img2.png" />
                </div>
                <div class="imagem">
                    <img src="<?php echo URL_TEMPLATE?>/imagens/img3.png" />
                </div>
                <div class="imagem">
                    <img src="<?php echo URL_TEMPLATE?>/imagens/img4.png" />
                </div>
        ...
        <section id="contato">
            ...
            <form action="email.php" name="form_email" method="POST">

            <input type="text" name="assunt" placeholder="Nome">
